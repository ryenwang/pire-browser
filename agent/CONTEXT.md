...
- MCP annotations mark local maintenance/context tools such as install, upgrade, status, sessions, profiles, and skills as non-open-world so hosts can present clearer approval prompts.
