...
$OriginalConfirmActions = $env:PIRE_BROWSER_CONFIRM_ACTIONS
$OriginalConfirmInteractive = $env:PIRE_BROWSER_CONFIRM_INTERACTIVE
...
try {
  ...
  Remove-Item Env:PIRE_BROWSER_CONFIRM_INTERACTIVE -ErrorAction SilentlyContinue
  ...
  $env:PIRE_BROWSER_CONFIRM_ACTIONS = "eval"
  ...
  if ($OriginalConfirmActions) {
    $env:PIRE_BROWSER_CONFIRM_ACTIONS = $OriginalConfirmActions
  } else {
    Remove-Item Env:PIRE_BROWSER_CONFIRM_ACTIONS -ErrorAction SilentlyContinue
  }
  if ($OriginalConfirmInteractive) {
    $env:PIRE_BROWSER_CONFIRM_INTERACTIVE = $OriginalConfirmInteractive
  } else {
    Remove-Item Env:PIRE_BROWSER_CONFIRM_INTERACTIVE -ErrorAction SilentlyContinue
  }
