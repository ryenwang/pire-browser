...
not native touch input or mobile browser chrome emulation.
...
Mouse, tap, and drag commands dispatch page-level Firefox WebExtension events. They do not control the native OS cursor or native touch input.
