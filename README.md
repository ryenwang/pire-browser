...
```powershell
pi install git:git@github.com:ryenwang/pire-browser@v0.1.4
```
...
gh release download v0.1.4 --repo ryenwang/pire-browser --pattern pire-browser-windows-x64.zip --dir "$env:TEMP\pire-browser-install"
