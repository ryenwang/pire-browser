...
describe("pire-browser command foundations", () => {
  ...
  it("supports persistent iframe context through frame refs", () => {
    ...
    expect(body).toContain('type: "frame_target_by_name"');
    expect(body).toContain("selectedFramesByTabId.set(tabId");
    expect(body).toContain("selectedFrameIdForTab(tab.tabId)");
    expect(body).toContain("childFrameForTarget");
    expect(body).toContain("childFrameForUrlTarget");
    expect(body).toContain("selectFrameByNameTarget");
    expect(body).toContain("selectFrameByUrlTarget");
    expect(body).toContain("looksLikeFrameUrlTarget");
    expect(body).not.toContain("Frame command accepted");
    expect(contentBody).toContain('if (message.type === "frame_target")');
    expect(contentBody).toContain('if (message.type === "frame_target_by_name")');
    expect(contentBody).toContain("function frameTargetLocator(locator: Locator)");
    expect(contentBody).toContain("function frameTargetByName(name: string)");
    expect(contentBody).toContain("function frameNameMatches(element: Element, target: string)");
