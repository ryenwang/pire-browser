"use strict";
{
    ...
    browser.runtime.onMessage.addListener((message) => {
        ...
        if (message.type === "frame_target_by_name")
            return Promise.resolve(frameTargetByName(String(message.name ?? "")));
        ...
        if (message.type === "screenshot_scrollbars")
            return Promise.resolve(setScreenshotScrollbarsHidden(Boolean(message.hidden)));
    ...
    function frameTargetByName(name) {
    ...
    function frameNameMatches(element, target) {
        const candidates = [
            attr(element, "name"),
            attr(element, "id"),
            attr(element, "title"),
    ...
    function frameTargetElement(element) {
        return {
    ...
    function setScreenshotScrollbarsHidden(hidden) {
