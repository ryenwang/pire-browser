...
| `skill-data/core/SKILL.md` | Runtime skill content | Full core skill served by `pire-browser skills cat/get core` through Rust `include_str!` and by the JS launcher fallback; keep version matched to CLI behavior. |
