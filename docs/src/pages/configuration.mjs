...
pire-browser set offline off`),
  ...
  table(["Variable", "Purpose"], [
    ...
    ["<code>AI_GATEWAY_API_KEY</code>", "Enables <code>pire-browser chat</code> through Vercel AI Gateway."],
    ["<code>AI_GATEWAY_MODEL</code>", "Optional model override for <code>chat</code>, defaulting to <code>anthropic/claude-sonnet-4.6</code>."],
    ["<code>AI_GATEWAY_URL</code>", "Optional AI Gateway base URL override for <code>chat</code>, defaulting to <code>https://ai-gateway.vercel.sh</code>."],
