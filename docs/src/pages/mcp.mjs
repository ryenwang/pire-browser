...
pire-browser mcp --tools all`),
  ...
  table(
    ...
    [
      ...
      ["debug", "Lower-level launch, explicit install/repair, safe upgrade, batch diagnostics, doctor/activity diagnostics, console, page errors, JavaScript dialogs, highlight, Firefox trace bundles, best-effort vitals, diffs, status, sessions/profiles, and close."],
  ...
  table(
    ...
    [
      ...
      ["pire_browser_console / errors / dialog_* / highlight / trace_* / vitals", "Inspect page logs, errors, JavaScript dialogs, visual targets, Firefox trace QA bundles, and best-effort performance signals."],
