...
pire-browser mcp --tools all`),
  ...
  table(
    ...
    [
      ...
      ["network", "Headers, credentials, offline toggle, network request inspection with redacted request/response headers and safe outgoing request-body previews, HAR export, and route/unroute controls."],
  ...
  table(
    ...
    [
      ...
      ["pire_browser_network_requests / request / har_* / route / unroute", "Inspect active-tab network metadata with redacted request/response headers and redacted/truncated outgoing request bodies when Firefox exposes them, record/export HAR, and register best-effort routes."],
