...
5. pire_browser_snapshot({ "interactive": true })`),
  ...
  table(
    ...
    [
      ...
      ["pire_browser_session_* / profiles_list / profiles_import", "Inspect live sessions, managed Firefox profiles, and importable local Firefox profiles, or copy a discovered/profile-path Firefox profile into managed pire-browser state."],
