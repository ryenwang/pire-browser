...
pire-browser mcp --tools all`),
  ...
  table(
    ...
    [
      ...
      ["pire_browser_click / dblclick / double_click / fill / type / press", "Perform page interactions. Prefer the agent-browser-style dblclick spelling for new MCP clients; double_click remains compatible."],
