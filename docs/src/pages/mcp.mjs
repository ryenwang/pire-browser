...
pire-browser mcp --tools all`),
  ...
  table(
    ...
    [
      ...
      ["state", "Cookies, storage, encrypted auth vault helpers, plaintext or opt-in encrypted state files, sessions, profiles, downloads/uploads, typed clipboard tools, and skills."],
      ["debug", "Lower-level launch, explicit install/repair, safe upgrade, batch diagnostics, doctor/activity diagnostics, console, page errors, JavaScript dialogs, highlight, Firefox trace bundles, screenshot-sequence recording bundles, best-effort vitals, diffs, status, sessions/profiles, and close."],
  ...
  table(
    ...
    [
      ...
      ["pire_browser_console / errors / dialog_* / highlight / trace_* / record_* / vitals", "Inspect page logs, errors, JavaScript dialogs, visual targets, Firefox trace QA bundles, screenshot-sequence recording bundles, and best-effort performance signals."],
