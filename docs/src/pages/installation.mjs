...
pire-browser doctor --json`),
  ...
  p("If launch fails with <code>web-ext exited before pire-browser connected</code> or a connection timeout, read the printed <code>Log:</code> path and follow the JSON <code>data.nextActions</code>: run <code>pire-browser doctor --json</code>, refresh setup with <code>pire-browser install</code>, close managed Firefox/web-ext processes for that profile, then retry."),
