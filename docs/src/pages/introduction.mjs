...
npx -y pire-browser@latest open example.com`),
  ...
  list([
    ...
    "<strong>Stateful:</strong> <a href=\"./sessions/\">isolated sessions</a>, compact restore, temporary profile snapshots, opt-in durable Firefox paths, encrypted auth, proxy, and <a href=\"./security/\">security controls</a> support long-running agents.",
