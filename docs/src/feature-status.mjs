...
export const featureStatuses = {
  ...
  mcp: {
    status: "available",
    summary: "`pire-browser mcp --tools core` starts a stdio MCP server with typed tools for the core open, inspect, semantic find, interact, get/check, wait, screenshot/PDF, console/errors/dialog/highlight/vitals, download/wait-download/upload, clipboard, status, tab/window, close, and skill-guidance workflow.",
