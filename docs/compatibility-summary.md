...
| Network and configuration | Partial | Domain allowlists, headers, network diagnostics, metadata-only HAR export, route mocks, and config defaults are available with documented limits. |
