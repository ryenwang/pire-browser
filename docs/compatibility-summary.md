...
| Core navigation and refs | Supported | Open, agent-friendly URL/active-tab reads including active-tab URL-backed `--llms`/markdown fetches, snapshot, refs, click, fill, get, wait, and tab workflows are available. |
