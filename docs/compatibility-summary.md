...
| MCP agent integration | Supported | `pire-browser mcp --tools core` exposes the main browser workflow as stdio MCP tools, including typed interaction, get/check, download/wait-download/upload, clipboard, tab, status, and skill helpers. |
