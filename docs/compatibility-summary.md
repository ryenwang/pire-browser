...
| Area | Status | Notes |
| --- | --- | --- |
| Install and setup | Supported | Global, project, and source installs are documented for the Firefox-backed package. Installed npm/Pi users can use `upgrade` or the lower-level `update` commands. |
